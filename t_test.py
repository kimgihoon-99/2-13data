# -*- coding: utf-8 -*-
"""
Created on Thu Feb 13 10:36:31 2025
...
일반적으로 유의확률 5%를 판단 기준
pvalue 0.05 미만 , 집단(변수)간 차이가 통계적으로 유의하다
compact 와 suv간 평균 도시연비 차이가 통계적으로 유의하다
'''
...
상관계수 : 0-1 사이의 값
          ...
          음수면 반비례
"""
## 실업자 수와(unemploy) 개인 소비 지출(pce)의 상관관계: economics.csv
